...
В первом случае значение *weight = 'uniform'*, т.е. все точки имеют одинаковый вес.

![](https://raw.githubusercontent.com/Kursaitova/KNN/master/wine1.PNG "kNN")

Во втором случае значение *weight = 'distance'*, т.е. весовая функция рпедставляет собой убывающая последовательность вещественных весов.
